...
const LogIn = () => {
  ...
  return (
    <div className='min-h-screen flex items-center justify-center bg-lime-800'>
      <section>
        <h1 className='text-center pb-5 text-4xl font-mono underline'>Quizify </h1>
        <form
        ...
        >
...

          {
            ...
            <span className='text-center text-red-500 text-sm'>
              Please Wait , the server might take a minute or two to respond. Please be patient!
            </span>
          }
